...
Неизменённый полный пакет Windows загружается по кнопке пользователя из закреплённого релиза [TNTwise/rife-ncnn-vulkan 20250112](https://github.com/TNTwise/rife-ncnn-vulkan/releases/tag/20250112). Исполнитель запускается отдельным процессом. Все модели, исходные `LICENSE` и `README.md` сохраняются при установке. Архив и веса не входят в portable-поставку VidCropper.

- Исполнитель: TNTwise, nihui и участники; MIT. Исходники: https://github.com/TNTwise/rife-ncnn-vulkan/tree/20250112 . Текст лицензии из закреплённого архива также сохранён в `licenses/ai/RIFE-ncnn-vulkan.txt`.
- Модели RIFE: https://github.com/hzwer/Practical-RIFE и https://github.com/hzwer/ECCV2022-RIFE . В официальном каталоге Practical-RIFE для моделей указана лицензия MIT. VidCropper использует преобразованные NCNN-модели поставщика архива без изменений.
- NCNN и включённые runtime-компоненты сохраняют собственные условия. MIT-лицензия VidCropper их не заменяет.
